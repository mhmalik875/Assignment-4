							...
							<form class="form-area " id="myForm" action="mail.php" method="post" class="contact-form text-right">
								<div class="row">	
									<div class="col-lg-6 form-group">
										...
										<input name="text" placeholder="Enter PhoneNo" onfocus="this.placeholder = ''" pattern="[\+]\d{2}\d{3}[\-]\d{3}[\-]\d{4}" title="Format is +92XXX-XXX-XXXX" onblur="this.placeholder = 'Enter PhoneNo'" class="common-input mb-20 form-control" required="" type="text">
