					...
					<div class="row">
						...
						<div class="col-lg-4">	
							<div class="single-cat">
								<a href="#" class="hb-sm-margin mx-auto d-block"><span class="hb hb-sm inv hb-facebook-inv"><span class="lnr lnr-trash"></span></span></a>
								<h4 class="mt-40 mb-20">Cleaning Service</h4>
								<p>
								</p>
							</div>															
						</div>
